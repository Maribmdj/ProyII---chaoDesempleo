CREATE TABLE `chaodesempleo`.`benefits` (
  `ID_BENEFITS` int(11) NOT NULL COMMENT 'UNIQUE IDENTIFIER OF THE TABLE',
  ...
  KEY `FK_IDSTATE_idx` (`STATE`),
  CONSTRAINT `FK_IDSTATE` FOREIGN KEY (`STATE`) REFERENCES `state` (`id_state`),
